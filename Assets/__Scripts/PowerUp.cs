...
public class PowerUp : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        //Set up the roPerSecond for the Cube child using roMinMax x & y
    ...
    void Update()
    {
        ...
        //Mulitplying it by Time.time causes the rotation to be time-based
    ...
    public void SetType(WeaponType wt)
    {
        ...
        letter.text = def.letter;   //Set the ltter that is shown
