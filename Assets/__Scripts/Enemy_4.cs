...
public class Enemy_4 : Enemy {
    ...
    void OnCollisionEnter(Collision coll)
    {
        ...
        switch (other.tag)
        {
            case "ProjectileHero":
                ...
                if (prtHit == null)
                {
                    //If prtHit wasn't found then it's usually becasue, very rarely, thisCollider on
                    //  contacts[0] will be the ProjectileHero instead of the ship part. If so, just look for
                    //  otherCollider insteasd
    ...
    //This changes the color of just one Part to red instead of the whole setup
